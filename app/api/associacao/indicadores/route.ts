...
export async function GET() {
  ...
  // Buscar todos consultores da associacao
  ...
  if (error) {
    console.error("[associacao/indicadores] GET:", error.code, error.message);
...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    ...
    console.error("[associacao/indicadores] POST:", error.code, error.message);
