  ...
  return (
    <div className="flex-1 flex flex-col">
      <div className="px-8 py-5 border-b border-border">
        <h1 className="text-base font-bold text-foreground">Historico de Indicacoes</h1>
        <p className="text-[11px] text-muted-foreground mt-0.5">Todas as pessoas que voce indicou</p>
      </div>
      <div className="flex-1 p-8 bg-muted/30">
        <Card className="shadow-sm">
          <CardHeader className="pb-3 border-b border-border">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-semibold">Minhas Indicacoes</CardTitle>
              <span className="text-xs text-muted-foreground">{leads?.length ?? 0} no total</span>
            </div>
          </CardHeader>
          <CardContent className="p-0">
            {!leads?.length ? (
              <div className="text-center text-muted-foreground text-sm py-16">Nenhuma indicacao ainda</div>
            ) : (
